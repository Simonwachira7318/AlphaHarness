...
export interface paths {
    ...
    "/api/alphas/{alpha_id}/ai/describe": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Describe
         * @description Draft the Alpha's name, category, tags and description. Saves nothing.
         */
        post: operations["describe_api_alphas__alpha_id__ai_describe_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/alphas/{alpha_id}/ai/remodel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Remodel
         * @description Ask a model for variants that address the failed checks, vet them, and queue them.
         */
        post: operations["remodel_api_alphas__alpha_id__ai_remodel_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/alphas/{alpha_id}/ai/remodels": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Remodels
         * @description Every variant remodelled from this Alpha, newest first, with its latest results.
         */
        get: operations["remodels_api_alphas__alpha_id__ai_remodels_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/auth/avatar": {
        ...
        /**
         * Avatar
         * @description The account's BRAIN profile picture, or 404 when it has none (the UI shows initials).
         */
        get: operations["avatar_api_auth_avatar_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/auth/forget": {
        ...
        /**
         * Forget
         * @description Sign out and delete the saved BRAIN login from the local vault.
         *
         *     The next sign-in needs the email and password typed again.
         */
        post: operations["forget_api_auth_forget_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/today/results": {
        ...
        /**
         * Results
         * @description Today's simulations by outcome, and the best Sharpe among those that completed.
         */
        get: operations["results_api_today_results_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        AssistRequest: {
            /**
             * Model
             * @description A model id; empty for the default
             */
            model?: string | null;
        };
        /** Assistant */
        ...
        Remodelled: {
            ...
            model: string;
            /** Queued */
            queued: components["schemas"]["Variant"][];
            /** Rejected */
        ...
        /**
         * TodayResults
         * @description How today's simulations ended, over the platform's day, as ``Sent Today`` counts it.
         */
        TodayResults: {
            best: components["schemas"]["BestToday"] | null;
            /** Cancelled */
            cancelled: number;
            /** Completed */
            completed: number;
...
export interface operations {
    ...
    describe_api_alphas__alpha_id__ai_describe_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Described"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    remodel_api_alphas__alpha_id__ai_remodel_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RemodelRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Remodelled"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    remodels_api_alphas__alpha_id__ai_remodels_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RemodelRow"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    results_api_today_results_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TodayResults"];
                };
            };
        };
    };
