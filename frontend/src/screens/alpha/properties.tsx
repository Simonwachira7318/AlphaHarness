    ...
    >
      <FillWithAi
        ...
        onFilled={(ai) =>
          setDraft({
            ...draft,
            name: ai.name || draft.name,
            category: ai.category !== 'NONE' ? ai.category : draft.category,
            tags: ai.tags.length ? ai.tags.join(', ') : draft.tags,
            description: ai.description || draft.description,
          })
        }
      />
